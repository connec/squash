(function() {
  ...
  exports.Squash = (function() {
    ...
    Squash.prototype.squash = function() {
      var alias, ast, directory, file, id, module, names, obfuscate, obfuscated, output, _, _i, _len, _path, _ref, _ref1, _ref2;
    ...
    Squash.prototype.require = function(name, from) {
      var dependency, file, names, _base, _i, _len, _name, _ref, _ref1;
      try {
      ...
      _ref1 = this.gather_dependencies(file);
    ...
    Squash.prototype.node_modules_dirs = function(from) {
      var dirs, i, parts, root, _i;
      parts = from.split(/\\|\//g);
      root = (i = parts.indexOf('node_modules')) !== -1 ? i : 0;
      i = parts.length - 1;
      dirs = [];
      for (i = _i = i; i <= root ? _i < root : _i > root; i = i <= root ? ++_i : --_i) {
