  ...
  exports.Squash = (function() {
    ...
    Squash.prototype.squash = function() {
      ...
      for (_j = 0, _len2 = _ref2.length; _j < _len2; _j++) {
        ...
        output += "register(" + (util.inspect(names)) + ", " + (util.inspect(directory)) + ", function(global, module, exports, require, window) {\n  " + module.js + "\n});";
      }
      output += '\n;}).call(this);';
    ...
    Squash.prototype.require = function(name, from) {
      ...
      try {
        ...
        if (this.options.relax) {
          if (typeof this.options.relax === 'function') this.options.relax(name);
          return;
        }
        throw error;
      }
