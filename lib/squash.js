(function() {
  ...
  exports.Squash = (function() {
    ...
    function Squash(options) {
      ...
      this.cwd = path.normalize(process.cwd());
      this.ext = null;
      this.cache = {};
      this.resolved = [];
      this.ordered = [];
    ...
    Squash.prototype.squash = function() {
      var module, output, path, _i, _j, _len, _len2, _ref, _ref2;
    ...
    Squash.prototype.require = function(x) {
      var ast, dependency, js, old_cwd, resolved, _i, _len, _ref, _ref2;
      if (__indexOf.call(this.resolved, x) >= 0) return;
      resolved = this.resolve(x);
      ...
      _ref = [this.cwd, path.dirname(resolved)], old_cwd = _ref[0], this.cwd = _ref[1];
      _ref2 = this.gather_dependencies(ast);
    ...
    Squash.prototype.resolve = function(x) {
      var resolved, y;
      y = path.resolve(this.cwd, x);
